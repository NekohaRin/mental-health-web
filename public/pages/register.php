...
<body class="h-screen w-full bg-cover bg-center" style="background-image: url(../assets/img/beground1.png) ">
    ...
    <div class="relative h-full w-full flex">
        ...
        <div class="z-10 w-full flex justify-center items-center">
            <div class="w-[380px]"></div>
            <div class="w-[570px] mr-7">
                ...
                <form action="../../app/controllers/process_register.php" method="POST" class="items-center">
                    <div class="flex mb-4 items-center">
                        <label class="w-92 text-xl font-semibold" for="username">Username:</label><br>
                    ...
                    <div class="flex mb-6 items-center">
                        <label class="w-92 text-xl font-semibold" for="email">Alamat Email:</label>
                        <span class="mx-3 text-xl font-bold">:</span>
                    ...
                    <div class="flex mb-6 items-center">
                        <label class="w-80 text-xl font-semibold" for="no_hp">Nomer Handphone</label>
                    ...
                    <div class="flex mb-6 items-center">
                        <label class="w-92 text-xl font-semibold" for="tanggal_lahir">Tanggal Lahir</label>
                        <span class="mx-3 text-xl font-bold">:</span>
                        <input class="border px-3 py-1 w-full rounded" type="date" id="tanggal_lahir" name="tanggal_lahir" required>
                    </div>

                    <div class="flex mb-6 items-center">
                        <label class="w-92 text-xl font-semibold" for="gender">Gender</label>
                        <span class="mx-3 text-xl font-bold">:</span>
                    ...
                    <!-- Password 2X -->
                    <div class="flex mb-6 items-center">
                        <label for="password" class="w-92 text-xl font-semibold">Password</label><br>
                        <span class="mx-3 text-xl font-bold">:</span>
                    ...
                    <div class="flex mb-6 items-center">
                        <label for="konpass" class="w-92 text-xl font-semibold">Konfirmasi Password</label>
                        <span class="mx-3 text-xl font-bold">:</span>
                    ...
                    <button type="submit" class="mb-4 bg-lime-600 font-bold text-xl px-7 py-3 ml-50 rounded-full">Registrasi</button>
                </form>
                <p class="ml-37">Sudah punya akun? <a href="login_email.php" class="text-lime-600 font-semibold">Kembali login</a></p>
            </div>
        </div>
    </div>
</body>
